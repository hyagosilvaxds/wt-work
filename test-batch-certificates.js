...
async function testBatchCertificates() {
  ...
  try {
    ...
    const classesResponse = await axios.get('https://api.olimpustech.com.br/api/classes');
    ...
    const studentsResponse = await axios.get(`https://api.olimpustech.com.br/api/classes/${testClass.id}/students`);
    ...
    const attendanceResponse = await axios.get(`https://api.olimpustech.com.br/api/classes/${testClass.id}/attendance`);
