...
async function testBatchCertificates() {
  ...
  try {
    ...
    const classesResponse = await axios.get('worktreinamentos.olimpustech.com/api/classes');
    ...
    const studentsResponse = await axios.get(`worktreinamentos.olimpustech.com/api/classes/${testClass.id}/students`);
    ...
    const attendanceResponse = await axios.get(`worktreinamentos.olimpustech.com/api/classes/${testClass.id}/attendance`);
