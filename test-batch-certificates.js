...
async function testBatchCertificates() {
  ...
  try {
    ...
    const classesResponse = await axios.get('https://olimpustech.com/api/classes');
    ...
    const studentsResponse = await axios.get(`https://olimpustech.com/api/classes/${testClass.id}/students`);
    ...
    const attendanceResponse = await axios.get(`https://olimpustech.com/api/classes/${testClass.id}/attendance`);
