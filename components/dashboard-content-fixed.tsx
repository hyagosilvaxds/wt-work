...
import { WeeklyTimelineCalendarFixed } from "@/components/weekly-timeline-calendar-fixed"
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Button
            variant="outline"
            size="sm"
            onClick={() => setCalendarView(calendarView === "monthly" ? "weekly" : "monthly")}
          >
            <CalendarIcon className="h-4 w-4 mr-2" />
            {calendarView === "monthly" ? "Visão Semanal" : "Visão Mensal"}
          </Button>
          <Button>
