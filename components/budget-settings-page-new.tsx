                ...
                <div key={page.id} className="p-4 border rounded-lg space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        value={page.name}
                        onChange={(e) => updateCoverPage(page.id, 'name', e.target.value)}
                    ...
                    <div>
                      ...
                      <Input
                        value={page.title}
                        onChange={(e) => updateCoverPage(page.id, 'title', e.target.value)}
                        disabled={!isEditing.coverPages}
                    ...
                    <div>
                      ...
                      <Input
                        value={page.subtitle || ''}
                        onChange={(e) => updateCoverPage(page.id, 'subtitle', e.target.value)}
                        disabled={!isEditing.coverPages}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateCoverPage(page.id, 'headerText', e.target.value)}
                        disabled={!isEditing.coverPages}
                        placeholder="Ex: Orçamento Personalizado"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateCoverPage(page.id, 'footerText', e.target.value)}
                        disabled={!isEditing.coverPages}
                    ...
                    <div>
                      ...
                      <Input
                        value={page.logoUrl || ''}
                        onChange={(e) => updateCoverPage(page.id, 'logoUrl', e.target.value)}
                        disabled={!isEditing.coverPages}
                        placeholder="https://..."
                      />
                    </div>
                    <div className="md:col-span-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => updateCoverPage(page.id, 'backgroundUrl', e.target.value)}
                        disabled={!isEditing.coverPages}
                        placeholder="https://..."
                      />
                    </div>
