...
import { Download, FileSpreadsheet, Calendar, MapPin, Users, Loader2, CheckCircle, AlertCircle } from "lucide-react"
import { exportInstructorsToExcel, downloadExcelFile, downloadBlobAsFile, InstructorExportFilters } from "@/lib/api/superadmin"
import { toast } from "sonner"

interface InstructorExcelExportModalProps {
  onExportCompleted?: () => void
}

export function InstructorExcelExportModal({ onExportCompleted }: InstructorExcelExportModalProps) {
  const [open, setOpen] = useState(false)
  const [loading, setLoading] = useState(false)
  const [filters, setFilters] = useState<InstructorExportFilters>({})
  ...
  const handleExport = async () => {
    try {
      ...
      // Exportar dados
      const exportData = await exportInstructorsToExcel(filters)
      ...
      toast.error('Erro ao exportar instrutores. Tente novamente.')
    } finally {
      setLoading(false)
    }
  }
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center text-xl">
            ...
            Exportar Instrutores para Excel
          </DialogTitle>
          <DialogDescription>
            Configure os filtros para exportar os instrutores desejados em formato Excel.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setFilters(prev => ({ 
                    ...prev, 
                    personType: value === 'TODOS' ? undefined : value as 'FISICA' | 'JURIDICA'
                  }))}
                >
                  <SelectTrigger>
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="activeOnly">Apenas instrutores ativos</Label>
              </div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {filters.personType && (
                    <Badge variant="secondary" className="bg-blue-100 text-blue-800">
                      ...
                      {filters.personType === 'FISICA' ? 'Pessoa Física' : 'Pessoa Jurídica'}
                    </Badge>
                  )}
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            ...
            <div className="text-sm text-gray-700 space-y-1">
              ...
              <p>• Colunas: Nome, Email, CPF/CNPJ, Telefone, Endereço, Status e mais</p>
