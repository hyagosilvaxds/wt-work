      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="students">Alunos ({turma.students.length})</TabsTrigger>
            <TabsTrigger value="lessons">Aulas ({turma.lessons.length})</TabsTrigger>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm">{turma.training.title}</p>
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm">{turma.training.durationHours}h</p>
                    </div>
                    <div>
